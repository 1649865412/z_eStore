...
<body>
<div class="container">
    	<div class="titsle"><img src="http://www.eluxuryoutlets.com/resources/images/email/el.jpg"></div>
        <div class="content">
        	<form action="" method="get">
            	<div class="info">We apologize for the disturb using text messeges, please enter your phone NO. to unsubscribe and stop receiving messages from us:<br>
              Your phone NO: XXXXX<br/>Email:xxx@xx.com</div>
                  <label for="Field1"  class="desc">
                	Phone Number
                </label>
                <div class="left">
                    <input type="tel"  tabindex="1" maxlength="3" size="3" value="" class="text"  >
                    <label for="Field1">###</label>
                </div>
                <div class="symbol">-</div>
                <div class="left">
                    <input type="tel"  tabindex="2" maxlength="3" size="3" value="" class="text" >
                    <label for="Field1-1">###</label>
                </div>
                <div class="symbol">-</div>
                <div class="left">
                 <input type="tel"  tabindex="3" maxlength="4" size="4" value="" class="text" >
              ...
              <div class="left">
                ...
                <input type="tel"  tabindex="1"  size="20" value="" class="text"  >
              </div>
